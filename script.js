...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=' + OtherCity1, options)
...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=' + OtherCity2 , options)
	.then(response => response.json())
    .then((response) => {
...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=' + OtherCity3 , options)
	.then(response => response.json())
    .then((response) => {
...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=' + OtherCity4 , options)
	.then(response => response.json())
    .then((response) => {
